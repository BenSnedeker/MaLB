...
impl<'b> TuiLoggerWidget<'b> {
    ...
    fn opt_output_separator(mut self, opt_sep: Option<String>) -> Self {
    ...
    /// Default is ':'
    pub fn output_separator(mut self, sep: String) -> Self {
    ...
    fn format_event(&self, evt: &ExtLogRecord) -> (String, Option<Style>) {
        ...
        if let Some(fmt) = self.format_timestamp.as_ref() {
            ...
            output.push_str(self.format_separator.as_str());
        }
...
pub struct TuiLoggerSmartWidget<'a> {
    ...
    style_off: Option<Style>,
    format_separator: Option<String>,
